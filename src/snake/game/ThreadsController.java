...
//        boolean hitWall = posCritique.getX() == 19 || posCritique.getY() == 19;
//        if (hitWall) {
//            stopTheGame();
//        }
...
//            System.exit(0);
    ...
    public void moveExterne() {
        ...
        for (Tuple t : positions) {
            int y = t.getX();
            int x = t.getY();
            Squares.get(x).get(y).lightMeUp(colorSnake);
